...
class DataGeneratorPlugin:
    ...
    def _register_commands(self):
        ...
        CommandFactory.register(["generate_batch_data", "批量生成数据"])(GenerateBatchDataCommand)
        CommandFactory.register(["register_data_template", "注册数据模板"])(RegisterDataTemplateCommand)
    ...
    def _register_builtin_generators(self):
        ...
        self.register_generator("mobile", self._generate_mobile, "手机号（别名）", "basic")
        self.register_generator("address", self._generate_address, "地址", "basic")
        self.register_generator("datetime", self._generate_datetime, "日期时间", "basic")
        ...
        self.register_generator("order_id", self._generate_order_id, "订单ID", "business")
        self.register_generator("product_code", self._generate_product_code, "产品编码", "business")
        self.register_generator("company_name", self._generate_company_name, "公司名称", "business")
        self.register_generator("bank_card", self._generate_bank_card, "银行卡号", "business")
        self.register_generator("id_card", self._generate_id_card, "身份证号", "business")
    ...
    def register_generator(self, data_type: str, generator: Callable, description: str = "", category: str = "custom"):
        """注册数据生成器"""
