...
class ObservabilityDashboard:
        ...
        performance_dashboard = Dashboard(
            ...
            widgets=[
                ...
                DashboardWidget(
                    ...
                    config={"min_value": 0, "max_value": 1000, "unit": "req/min"},
                ...
                DashboardWidget(
                    ...
                    config={"show_labels": True, "show_percentages": True},
    ...
    def get_dashboard_data(self, dashboard_id: str) -> Dict[str, Any]:
        ...
        for widget in dashboard.widgets:
            ...
            widget_data[widget.id] = {"config": widget, "metrics": widget_metrics}
    ...
    async def _create_alert(
        self, metric_name: str, current_value: float, rule: Dict[str, Any]
    ) -> None:
        """创建告警
        ...
        if event_type in self.subscribers:
            for callback in self.subscribers[event_type]:
                try:
                    ...
                    logger.error("通知订阅者失败", event_type=event_type, error=str(e))
    ...
    def import_dashboard_config(self, config_json: str) -> Optional[str]:
        ...
        try:
            ...
            # 重新构建对象
            widgets = [
                DashboardWidget(**widget_data) for widget_data in config["widgets"]
            ]
