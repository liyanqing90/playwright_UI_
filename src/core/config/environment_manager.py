...
class EnvironmentManager:
    ...
    def _detect_environment(self, default: str) -> str:
        ...
        # 1. 检查环境变量
        env_from_var = os.getenv(
            "PLAYWRIGHT_ENV", os.getenv("ENV", os.getenv("ENVIRONMENT"))
        )
        if env_from_var:
    ...
    def _load_environment_configs(self) -> Dict[str, EnvironmentInfo]:
        ...
        return {
            Environment.DEVELOPMENT.value: EnvironmentInfo(
                ...
                log_level="DEBUG",
                config_overrides={
                    "timeouts": {"default": 10000, "short": 3000, "long": 30000},
                    "retry": {"default_count": 1, "default_delay": 500},
                    "performance": {
                        "enable_monitoring": False,
                        "metrics_collection": False,
                    },
                    "logging": {"level": "DEBUG", "enable_service_logs": True},
                },
            ),
            Environment.TESTING.value: EnvironmentInfo(
                ...
                log_level="INFO",
                config_overrides={
                    "timeouts": {"default": 15000, "short": 5000, "long": 45000},
                    "retry": {"default_count": 2, "default_delay": 1000},
                    "assertion": {"strict_mode": False},
                    "logging": {"level": "INFO", "enable_service_logs": True},
                },
            ),
            Environment.STAGING.value: EnvironmentInfo(
                ...
                log_level="INFO",
                config_overrides={
                    "timeouts": {"default": 25000, "short": 8000, "long": 60000},
                    "retry": {"default_count": 3, "default_delay": 1500},
                    "performance": {
                        "enable_monitoring": True,
                        "metrics_collection": True,
                    },
                    "logging": {"level": "INFO", "enable_service_logs": False},
                },
            ),
            Environment.PRODUCTION.value: EnvironmentInfo(
                ...
                log_level="WARNING",
                config_overrides={
                    "timeouts": {"default": 30000, "short": 10000, "long": 90000},
                    "retry": {
                        "default_count": 3,
                        "default_delay": 2000,
                    ...
                    "assertion": {"strict_mode": True},
                    "logging": {"level": "WARNING", "enable_service_logs": False},
                },
            ),
            Environment.LOCAL.value: EnvironmentInfo(
                ...
                log_level="DEBUG",
                config_overrides={
                    "timeouts": {"default": 5000, "short": 2000, "long": 15000},
                    "retry": {"default_count": 1, "default_delay": 200},
