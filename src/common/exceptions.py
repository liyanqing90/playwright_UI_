...
class ElementNotFoundError(AutomationError):
    ...
    def __init__(
        ...
        details = {"selector": selector, "timeout": timeout, "page_url": page_url}
...
class CommandExecutionError(AutomationError):
    ...
    def __init__(
        self, command: str, reason: str, step_data: Optional[Dict[str, Any]] = None
    ):
        ...
        details = {"command": command, "reason": reason, "step_data": step_data}
...
class TimeoutError(AutomationError):
    ...
    def __init__(
        self, operation: str, timeout: int, actual_time: Optional[float] = None
    ):
...
class AssertionError(AutomationError):
    ...
    def __init__(
        ...
        error_message = (
            message or f"Assertion failed: expected {expected}, got {actual}"
        )
