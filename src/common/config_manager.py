...
class ConfigManager:
    ...
    def _register_default_schemas(self):
        ...
        schemas = [
            ...
            ConfigSchema(
                ...
                optional_keys=["retry_count", "parallel_workers", "screenshot_on_failure"],
                default_values={
                    "retry_count": 3,
                    "parallel_workers": 1,
    ...
    def _validate_config(self, config_name: str, config_data: Dict[str, Any], schema: ConfigSchema):
        """验证配置数据
    ...
    def export_config(self, config_type: str, output_path: Optional[Union[str, Path]] = None) -> str:
        """导出配置到文件
