...
class PerformanceMonitor:
    ...
    def __init__(self, monitoring_interval: float = 10.0, max_history: int = 100,
    ...
    def _collect_metrics(self):
        ...
        try:
            ...
            if self.lightweight_mode and len(self.stats.metrics_history) % 3 != 0:
                ...
                browser_instances = self.stats.metrics_history[-1].browser_instances if self.stats.metrics_history else 1
            else:
        ...
        try:
            ...
            for proc in psutil.process_iter(['name']):
                try:
                    ...
                    # 只检查明确的浏览器进程名
                    if any(browser in proc_name for browser in ['chrome', 'chromium', 'firefox', 'webkit']):
                        browser_processes += 1
