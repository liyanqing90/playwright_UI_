...
class PerformanceManager:
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'operations_per_second': self._stats['total_operations'] / runtime if runtime > 0 else 0,
            'slow_operation_rate': (self._stats['slow_operations'] / self._stats['total_operations'] * 100) if self._stats['total_operations'] > 0 else 0
        }
